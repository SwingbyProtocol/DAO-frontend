  ...
  return (
    <div className="card">
      ...
      <div className="card-row flexbox-list p-24" style={{ '--gap': '32px' } as React.CSSProperties}>
        ...
        <div>
          <Hint
            text={`If the creator’s vSWINGBY balance falls below ${minThreshold}% of the total amount of $SWINGBY staked in the DAO the proposal can be cancelled by anyone.`}>
            <Text type="small" weight="semibold" color="secondary" className="mb-4">
              Creator threshold
            </Text>
          </Hint>
